#!/bin/bash
#
# deploy.sh — Deploy, pause, or resume the ITEA 2026 Vendor Lock-In slides
#
# Usage:
...
REPO="michaelsoltys/ITEA2026-Vendor"
SITE_URL="https://michaelsoltys.github.io/ITEA2026-Vendor/"
...
case "${1:-deploy}" in
  ...
  deploy|--deploy)
    if ! git diff --quiet HEAD -- slides_vendor_itea2026.md public/ .github/ 2>/dev/null || [ -n "$(git ls-files --others --exclude-standard -- slides_vendor_itea2026.md public/ .github/)" ]; then
      git add slides_vendor_itea2026.md public/ .github/
